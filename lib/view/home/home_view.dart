              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text("${checkDoneTask(tasks)} de ${tasks.length} Tarefas completas",
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text("Gian Felipe da Silva", style: textTheme.headline2),
          Text("Mobile Engineer", style: textTheme.headline3),
          Container(
